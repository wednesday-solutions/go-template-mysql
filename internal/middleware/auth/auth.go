...
// WhiteListedQueries ...
var WhiteListedQueries = []string{"__schema", "introspectionquery", "login", "userNotification", "createEmployee", "updateEmployee", "deleteEmployee", "employee", "employees", "incidentReport"}
